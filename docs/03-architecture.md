...
- [x] Godot scenario worlds / node console / playbook bots → **accepted** ([ADR 0009](decisions/0009-godot-scenario-worlds.md); plan [09](09-godot-scenario-worlds.md); [11](11-helen-alice-cot-beats.md) / [12](12-helen-alice-build.md))
